...
### 6. Review a pasted meeting transcript

After the meeting, the facilitator can paste transcript text into the retrospective.

The system analyzes the pasted text and suggests:
...
**Why:** Automated extraction can misunderstand context, ownership, or tentative statements. Automatic publishing would reduce trust and could assign work incorrectly.
...
Allows the facilitator to paste transcript text and request draft outcomes.

Shows the generated results for review.
...
- Audio, video, or transcript-file uploads
...
- Time from transcript submission to published summary
...
6. Paste meeting transcript text
